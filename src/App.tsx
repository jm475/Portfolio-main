import './App.css'
import PomodoroTimerScreenshot from './assets/PomodoroTimerScreenshot.png';
import MobileApplicationPrototypeScreenshot from './assets/MobileApplicationPrototypeScreenshot.png';
      ...
      <section id="projects">
          ...
          <div className="project-grid">
              <a className="project-tile" href="https://pomodoro-lockin.netlify.app/" target="_blank">
                  <img className="project-image" src={PomodoroTimerScreenshot} alt="project" />
              ...
              <a className="project-tile" href="https://www.figma.com/proto/qNBZ99xiI7UUhvjJJa7XXh/Mobile-Application-Prototype?type=design&node-id=3-34&t=Iifr6VuHWyf6mK2p-1&scaling=scale-down&page-id=0%3A1&starting-point-node-id=3%3A34" target="_blank">
                  <img className="project-image" src={MobileApplicationPrototypeScreenshot} alt="project" />
